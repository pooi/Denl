...
class ChatManager {
            ...
            axios({
                ...
                for(var item in chatManager.data.chat_lists){
                    if(chatManager.data.chat_lists[item].roomport == result_data.roomport){
                        ...
                        chatManager.scrollToEndNoDelay();
                    }else{
                        continue;
                    }
                }
    ...
    scrollToEnd() {
        ...
        try{
            $('#popScrollList').animate({
                scrollTop: $('#popChatList')[0].scrollHeight + 100
            }, 500);
        }catch (e){
    ...
    send() {
        console.log("Send In ", this.data.message);
